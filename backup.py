...
#             await message.channel.send(f"Congratulations! you have completed {firstline_seg[2]}")
#     else:
#         await message.channel.send(" Warning! Please check your format.Write as per the instructions.")
       

# bot.run('MTE1ODAyNTUxMzU5NjYzMzE0OA.G9fjVN.SxioGHX0Ar46xkjrlXyAKBOmAHBujrWz8FEmbw')
